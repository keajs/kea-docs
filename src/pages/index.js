                ...
                <div className="container">
                    ...
                    <div className="trusted-logos">
                        ...
                        <a target="_blank" rel="noopener noreferrer" href="https://www.posthog.com">
                            <span className="posthog">
                                <img src={useBaseUrl('img/trusted/posthog.png')} />
                                <span>PostHog</span>
                            </span>
                        </a>
                    ...
                    <div className="container">
                        ...
                        <div className="row">
                            <div className="col text--center" style={{ fontSize: 16, marginTop: 18 }}>
                                Want to see a full app written with Kea? Check out <a href="https://github.com/PostHog/posthog">PostHog</a>.
