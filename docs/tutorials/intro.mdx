...
In this tutorial we cover [`actions`](/docs/core/actions),
[`reducers`](/docs/core/reducers), [`listeners`](/docs/core/listeners), [`selectors`](/docs/core/selectors),
[`afterMount`](/docs/core/effects), [`kea-forms`](/docs/plugins/forms) and [`kea-router`](/docs/plugins/router).

We're going to start with installing kea, running through the core logic builders, and then build ever more complex scenes.

## Video Tutorial

[Watch the tutorial on YouTube](https://www.youtube.com/watch?v=zpu4vZX-r_Q).
