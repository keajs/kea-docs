...
import { Github as Github1 } from '../../src/components/tutorials/github/1-component/index.js'
import { Github as Github2 } from '../../src/components/tutorials/github/2-logic/index.js'
import { Github as Github3 } from '../../src/components/tutorials/github/3-almost/index.js'
import { Github as Github4 } from '../../src/components/tutorials/github/4-event/index.js'
import { Github as Github5 } from '../../src/components/tutorials/github/5-breakpoint/index.js'
import { Github } from '../../src/components/tutorials/github/index.js'
import { Toggle } from '../../src/components/tutorials/github/toggle.js'
import { Example } from '../../src/components/tutorials/github/example.js'
import useBaseUrl from '@docusaurus/useBaseUrl'
import { kea } from 'kea'

# Build a GitHub API client in 20 minutes

:::warning This tutorial needs a refresh
This tutorial was written for Kea 2.0.
The video version of this tutorial, along with a Kea 3.0 refresh, is coming soon.
The content is still 100% valid for Kea 3.0, so feel free to read it.
:::
...
To follow along, you must have a good understanding of React and you _should_ have gone through [core concept](/docs/core/) pages at
least once.
...
:::note
To code along, see the [installation instructions](/docs/intro/installation)
:::
...
Let's refer back to this illustration from the [What is Kea](/docs/intro/what-is-kea) page:
...
In Kea, everything starts with an [**action**](/docs/core/actions). Every button press, every change in a textfield,
...
To store data you use a [**reducer**](/docs/core/reducers). Reducers are functions that react to actions and change
...
import { kea, actions, reducers, useActions, useValues } from 'kea'
...
The next step is to use a [**listener**](/docs/core/listeners) to listen for the `setUsername` action and run some code
...
It _almost_ works! Almost. Try changing the value in the textfield.
...
To load the repositories on page load, we can hook into the `afterMount` [event](/docs/core/events)
...
Luckily listeners come with one very cool feature: [breakpoints](/docs/core/listeners#breakpoints).
...
_"in case another `setUsername` listener was started while I was waiting, stop now"_.

In practical terms, you can use it to debounce calls.

Calling `await breakpoint(300)` as the _first thing_ in the `setUsername` listener pauses the request to
...
[**selector**](/docs/core/selectors) to sort it dynamically and automatically.
...
I opted to avoid it in the example above. See the [listeners](/docs/core/listeners)
...
This will be the left as an exercise for the _ambitious_ reader. That's you, right? 😉
