...
Kea organises state in containers called `logic`, which are _pretty big_ and _pretty opinionated_ units of state,
...
Click on any of the links above (starting with [`kea()`](/docs/core/kea)), or just read through the [core](/docs/core/), [meta](/docs/meta/) and [plugins](/docs/plugins/) sections to learn more.
