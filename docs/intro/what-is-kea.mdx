...
It's all pretty standard stuff you've surely seen elsewhere, but with a few twists (look for [_breakpoints_](/docs/core/listeners#breakpoints)), and in a nice package.
