...
Now in early 2022, it's time for yet another shift. [Kea 3.0](/blog/kea-3.0/) finally introduces [logic builders](/docs/intro/what-is-kea#logic-builders), a concept that
makes it possible for anyone to build abstractions on top of Kea. The new [`kea-forms`](/docs/plugins/forms) plugin is an example of one such abstraction.
