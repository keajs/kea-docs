...
Try kea `2.0.0-beta.5` to test the new goodies today!
:::
...
Start with the [quickstart](/docs/introduction/quickstart) if you're new to Kea. Then head on to the  [core concepts](/docs/guide/concepts). 
Please also read them if you've been using Kea for a while. You might learn something you didn't know!
Then check out [advanced concepts](/docs/guide/advanced), [debugging](/docs/guide/debugging) and other pages for more. 
