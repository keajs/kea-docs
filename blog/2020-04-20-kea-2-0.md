...
inside a listener. For that please read the section in the [Using without React](/docs/guide/standalone#calling-mount-inside-listeners-with-autoconnect-true) 
page.
