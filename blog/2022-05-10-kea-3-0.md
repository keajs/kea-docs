...
Kea's syntax hasn't kept up with the way Kea was being used, passing everything through a huge object was getting in the
way of extensibility, and it was time for a refresh.
...
To learn more, read through the [completely revamped documentation](/).
